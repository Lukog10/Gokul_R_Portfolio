...
const pages = [
    ...
    },
    {
        ...
        leftContent: {
            heading: 'AI & Gen AI',
            description: 'Developing autonomous agent workflows and prompt engineering solutions. Leveraging LLM Fine-Tuning tools, Hugging Face, and Streamlit to prototype zero-trust prompt shields and RAG intelligence tools.',
            skills: ["AI Agents", "Prompt Engineering", "LLM Fine-Tuning", "Hugging Face", "Streamlit", "RAG Systems"],
