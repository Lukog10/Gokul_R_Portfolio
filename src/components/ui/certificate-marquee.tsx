...
const certificates = [
  "/certificate/Accenture Data analytics certificate .pdf",
  "/certificate/Google Analytics certification.pdf",
  "/certificate/IMG_1729257197539.jpg",
  "/certificate/IMG_1732167055301.jpg",
  "/certificate/LinkedIn Learning Certificate (1).pdf",
  "/certificate/LinkedIn Learning Certificate.pdf",
  "/certificate/TATA Data visualization certificate .pdf",
  "/certificate/VF6eQ1bV8SfqKBpu8AVD_4G93sg9wJQ0wWe9CTc_J_4=.png",
  "/certificate/a1155728-b6f3-4dcb-ba3a-0449dce01f57_copy.pdf",
  "/certificate/b348fec9292745a027be72c56428fa1f0f383487bafef09e52355d05f2c91f3c.png",
            ...
            {isPdf ? (
              <div className="absolute inset-0 w-full h-full bg-white overflow-hidden">
                <iframe
                  ...
                  className="absolute left-0 w-full object-cover opacity-90 pointer-events-none"
