...
const GITHUB_USER = "Lukog10";

const PINNED_REPOS = [
  {
    name: "portfolio",
    desc: "Personal portfolio website showcasing data science projects, ML skills, and professional journey. Built with HTML, CSS, and JavaScript.",
    stars: 5,
    forks: 1,
    lang: "HTML",
    url: "https://github.com/Lukog10/portfolio"
  },
  {
    name: "vault-aegis",
    desc: "Zero-trust AI security gateway for LLM deployments with prompt injection defence and PII sanitization. Won 1st Prize at hackathon.",
    stars: 8,
    forks: 2,
    lang: "Python",
    url: "https://github.com/Lukog10/vault-aegis"
  },
  {
    name: "video-games-sales-prediction",
    desc: "Benchmarked Linear Regression, Random Forest and XGBoost to predict global game sales across 16,000+ titles, achieving R-squared = 0.84.",
    stars: 4,
    forks: 1,
    lang: "Jupyter Notebook",
    url: "https://github.com/Lukog10/video-games-sales-prediction"
  },
  {
    name: "land-approval-prediction",
    desc: "Classification model on land documentation data to predict approval probabilities with 3x F1 improvement. Deployed via Streamlit.",
    stars: 3,
    forks: 1,
    lang: "Python",
    url: "https://github.com/Lukog10/land-approval-prediction"
  },
  {
    name: "laptop-price-prediction",
    desc: "Optimized Random Forest regression on 1,000+ device configurations achieving R-squared = 0.88 in predicting market prices.",
    stars: 5,
    forks: 2,
    lang: "Jupyter Notebook",
    url: "https://github.com/Lukog10/laptop-price-prediction"
  },
  {
    name: "london-bike-ride-analysis",
    desc: "Uncovered seasonal demand patterns and quantified ~23% higher weekend demand via interactive Tableau dashboards and Python analytics.",
    stars: 3,
    forks: 1,
    lang: "Python",
    url: "https://github.com/Lukog10/london-bike-ride-analysis"
  }
];
