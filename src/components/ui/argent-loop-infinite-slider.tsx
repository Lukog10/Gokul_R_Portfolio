...
const PROJECT_DATA: ProjectData[] = [
  ...
  },
  {
    ...
    category: "AI & Machine Learning",
    year: "2025",
    description: "Predict laptop prices using machine learning models trained on hardware specifications.",
    slug: "laptop-price-prediction"
  },
  {
    title: "VAULT-Aegis Security",
    image: "/projects/vault-aegis-minimal.png",
    category: "AI Security Gateway",
    year: "2025 - 2026",
    description: "Zero-trust AI security gateway for LLM deployments with prompt injection defence.",
    slug: "vault-aegis"
  },
  {
    ...
    year: "2025",
    description: "Predict global game sales using Linear Regression, Random Forest and XGBoost.",
  ...
  },
  {
    ...
    year: "2026",
    description: "Trained classification models on land records with a 3× F1 score improvement.",
  ...
  },
  {
    ...
    year: "2026",
    description: "Extracted behavioral patterns from survey responses to map dependency risks.",
  ...
  },
  {
    ...
    year: "2025",
    description: "Uncovered seasonal patterns and weather impacts via interactive Tableau dashboards.",
