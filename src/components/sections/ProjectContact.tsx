            ...
            <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center justify-between gap-16 lg:gap-20">
                <div className="relative z-10 w-full lg:w-1/2">
                    <BlockInTextCard
                        ...
                        text={
                            <>
                                <strong>Ready to unlock the power of your data?</strong> From predictive machine learning models to interactive BI dashboards, let's collaborate to drive actionable insights.
                            </>
                        }
                        examples={[
                            "Looking for a Data Analyst & ML Developer?",
                            "Need help training predictive models?",
                            "Need an interactive BI dashboard?",
                        ]}
                    />
                </div>
