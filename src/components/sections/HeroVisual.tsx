      ...
      <main className="relative flex-1 flex flex-col justify-center pt-40 pb-20 z-10">
        <div className="flex relative gap-4 px-6 md:items-center w-full flex-col justify-center">
          ...
          <div className="md:flex gap-8 items-center relative">
            ...
            >
              Hi, I'm {personal.name}. I transform data into intelligent, scalable solutions.
            </motion.p>
          ...
          <div className="md:flex gap-8 items-center relative">
            <div className="relative">
              ...
              <div ref={instagramRef} className="absolute -bottom-12 right-24 md:right-36 text-primary/60 hover:text-primary z-20 opacity-0 hidden md:block">
                <a
              ...
              <motion.h1
                ...
                className="text-[clamp(3rem,11vw,13rem)] flex items-center font-black leading-[0.85] tracking-tighter text-shiny will-change-transform px-4"
              >
                <span className="">AN</span>
                <div
                  ref={zapRef}
                  className="hidden lg:block mx-[0.05em] relative group"
                >
                  <Zap className="w-[0.8em] h-[0.8em] text-sky-400" strokeWidth={1.5} />
                </div>
                <div
                  ref={zapSmallRef}
                  className="block lg:hidden mx-[0.02em] relative group"
                >
                  <Zap className="w-[0.8em] h-[0.8em] text-sky-400" strokeWidth={2} />
                </div>
                <span className="">ALYST</span>
              </motion.h1>
            </div>
          </div>
            ...
            {showProfile && (
              ...
              >
                <ProfileCard
                  ...
                  description="I am a dedicated Data Analyst and ML Developer focused on extracting insights and building predictive, intelligent systems. I specialize in bridging technical data science with high-performance execution to deliver meaningful and impactful digital solutions."
