                        ...
                        {achievement.image ? (
                            <>
                                {achievement.image.endsWith('.pdf') ? (
                                    <div className="absolute top-[-5%] left-[-5%] w-[110%] h-[110%] group-hover:scale-105 transition-transform duration-700 transform-gpu overflow-hidden">
                                        <iframe
                                            src={`${achievement.image}#toolbar=0&navpanes=0&scrollbar=0`}
                                            className="absolute left-0 w-full object-cover opacity-80 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none border-0 bg-transparent"
                    ...
                    <div className="max-w-5xl mx-auto px-6">
                        ...
                        >
                            <ErrorBoundary fallback={<div className="text-center opacity-50">Visuals Unavailable</div>}>
                                <FallingText
                                    text="Python SQL Excel Scikit-Learn PyTorch PowerBI Tableau XGBoost Pandas NumPy HuggingFace Streamlit LangChain Git VSCode Jupyter"
                                    highlightWords={['Python', 'SQL', 'Scikit-Learn', 'PyTorch', 'Tableau', 'PowerBI']}
                                    trigger="scroll"
                                    gravity={0.8}
