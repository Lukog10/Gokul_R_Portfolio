...
const highlightContent = {
    education: {
        ...
        description: "Every dataset tells a story. My academic journey at The American College, Madurai shapes how I approach complex analytical problems with logical thinking."
    },
    journey: {
...
function ExperienceTabSlider({ isLowPowerMode }: { isLowPowerMode: boolean }) {
    ...
    const tabs: TabItem[] = [
        { id: 'education', label: 'Education', description: 'Building strong foundations through academic excellence at The American College, Madurai and specialized certifications.' },
        { id: 'journey', label: 'Experience', description: 'A timeline of roles, responsibilities, and professional growth across various organizations.' },
    ];
